...
const file_worldengine_isc_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x1eworldengine/isc/v1/query.proto\x12\x12worldengine.isc.v1\x1a\x1bbuf/validate/validate.proto\"\x95\x02\n" +
	"\x05Query\x123\n" +
	"\x04find\x18\x01 \x03(\tB\x1f\xbaH\x1c\x92\x01\x19\"\x17r\x15\x18\x80\x012\x10^[a-zA-Z0-9_-]+$R\x04find\x12?\n" +
	"\x05match\x18\x02 \x01(\x0e2\x1f.worldengine.isc.v1.Query.MatchB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05match\x12\x14\n" +
	"\x05where\x18\x03 \x01(\tR\x05where\x12\x14\n" +
	"\x05limit\x18\x04 \x01(\rR\x05limit\x12\x16\n" +
	"\x06offset\x18\x05 \x01(\rR\x06offset\"R\n" +
	"\x05Match\x12\x15\n" +
	"\x11MATCH_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vMATCH_EXACT\x10\x01\x12\x12\n" +
	"\x0eMATCH_CONTAINS\x10\x02\x12\r\n" +
	"\tMATCH_ALL\x10\x03\")\n" +
	"\vQueryResult\x12\x1a\n" +
	"\bentities\x18\x01 \x03(\fR\bentitiesBmZPgithub.com/limike954/trajectory-data-00009/proto/gen/go/worldengine/isc/v1;iscv1\xaa\x02\x18WorldEngine.Proto.Isc.V1b\x06proto3"
